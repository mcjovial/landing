  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide>
          <img src='/assets/images/sliders/5.jpg' />
        </SwiperSlide>
      ...
      <div className='absolute z-10 -translate-x-1/2 bottom-[70%] md:bottom-1/3 left-1/2 text-center'>
        ...
        <p className='text-white md:block hidden text-2xl my-8'>
          Our experience ensures that your projects will be done right and with
          the upmost professionalism.
        </p>
        <button className='md:inline hidden uppercase cursor-pointer bg-[#0497f3] text-white px-8 py-3 text-sm rounded'>
