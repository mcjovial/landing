      ...
      <div className='py-16 bg-white'>
        <div className='container m-auto'>
          <div className='text-center m-auto mb-10'>
            ...
            <div className='bg-[#f3b004] p-0.5 max-w-[80px] m-auto'></div>
          </div>
          <div className='md:grid md:grid-cols-3 md:gap-16 space-y-10 md:space-y-0'>
            <div className='flex'>
              <p className="inline-flex items-center justify-center w-16 h-16 mr-6 text-pink-100 transition-colors duration-150 bg-[#f3b004] rounded-full focus:shadow-outline hover:bg-white hover:text-amber-400 hover:border-amber-400 hover:border-2">
