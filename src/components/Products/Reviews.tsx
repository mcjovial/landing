      ...
      <div>
        <div className='flex md:flex-row flex-col md:justify-between gap-8'>
          ...
          <div className='md:w-2/3 text-[#807e7e] space-y-4'>
            <p className='uppercase text-sm font-bold text-[#494848]'>Submit your review</p>
            <p>Your email address will not be published. Required fields are marked*</p>
            <form action="" className='w-full space-y-5'>
              <div>
                <textarea className='w-full border px-4 py-4 focus:outline focus:outline-[#a19f9f] focus:border-none' name="message" id="" rows={6} placeholder='Message*'></textarea>
              </div>
